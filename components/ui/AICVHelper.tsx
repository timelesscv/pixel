  ...
  const handleParserUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    reader.onloadend = async () => {
        ...
        try {
            ...
            // Updated model to gemini-3-flash-preview for multimodal text extraction tasks
            const response = await ai.models.generateContent({
                model: 'gemini-3-flash-preview',
                contents: {
                    parts: [
            ...
            if (text) {
                // Strip markdown to ensure valid JSON
                ...
                if (parsed.expCountry) {
                    ...
                    updates.expCountry = parsed.expCountry.toUpperCase();
                    updates.expPeriod = parsed.expPeriod;
                    updates.expPosition = parsed.expPosition.toUpperCase();
                }
